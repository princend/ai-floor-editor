...
const translations = {
  zh: {
    ...
    aiMode: "AI 重繪會使用低負載本機模型。高品質 SDXL 請用環境變數手動啟用。",
    aiPrompt: "AI 重繪會在本機載入模型。建議先用材質貼圖，AI 只做少量測試。",
    textureMode: "材質貼圖會使用你上傳的材質圖片。",
    fastMode: "快速預覽使用本機程式產生材質。",
    fastReady: "快速預覽已就緒。",
    aiBusy: "AI 重繪執行中。期間電腦可能變慢，建議不要同時開太多大型程式。",
  ...
  en: {
    ...
    aiMode: "AI inpaint uses a lower-load local model. Enable SDXL manually with an environment variable.",
    aiPrompt: "AI inpaint loads a local model. Prefer texture match first, then use AI for small tests.",
    ...
    aiBusy: "AI inpaint is running. The computer may slow down while the model is active.",
